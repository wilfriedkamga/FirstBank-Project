...
import Tabs from '../../../Front_Saving/Component/tabs/Tabs';
import LastOngoingPlan from '../../../Front_Saving/Component/Ongoing Plans/LastOngoingPlan';
...
const SavingsDash = () => {
  return (
    <div className='w-full h-full bg-white flex flex-col'>
      ...
      <div className="flex mt-[10vh] flex-col pt-5 h-full w-full space-y-6 overflow-auto">
        <AccountBalanceBox />
        ...
        <div className="w-full flex flex-row justify-start">
          <Link to="/savings/newPlan" className='justify-center items-center'>
            <div className="rounded-lg h-16 w-16 mb-1 mx-5 md:h-24 md:w-24 p-2.5 md:p-3.5">
              <img src='./assets/images/iconTopUp.svg' alt="logo" width={200} height={300} />
            </div>
            <span className='font-account text-center px-3'>Top Up my Wallet</span>
          </Link>
          <Link to="/savings/newPlan" className='justify-center items-center'>
            <div className="rounded-lg h-16 w-16 mb-1 mx-5 md:h-24 md:w-24 p-2.5 md:p-3.5">
              <img src='./assets/images/iconWithdraw.svg' alt="logo" width={200} height={300} />
            </div>
            <span className='font-account text-center px-3'>Withdraw my Wallet</span>
          </Link>
        </div>
        <div className="pt-5 ml-5 border-b border-gray-200">
          <h3 className='font-title font-semibold text-[#0C1013] text-md'>Ongoing Plans</h3>
        </div>
        <LastOngoingPlan />
