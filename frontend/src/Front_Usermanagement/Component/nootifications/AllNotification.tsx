...
import logo_caisse from "../../../Front_Association/Assets/caisse.png";
...
const AllNotifications: React.FC = () => {
  ...
  const [listNotifs, setListNotifs] = React.useState<Notification[]>([]);
                ...
                <div className="flex justify-between relative bottom-3 p-1 gap-5 w-full">
                  {!notif.stateConfirmation ? (
                    <>
                      <button
                        onClick={() => {
                          handleConfirmNotification(index);
                        }}
                        className="bg-red-600 w-1/2 hover:bg-red-800 rounded-lg text-xs text-white py-1 px-[30px]"
                      >
                        ACCEPTER
                      </button>
                      <button
                        onClick={() => {
                          handleUnConfirmNotification(index);
                        }}
                        className="bg-gray-400 hover:bg-gray-600 w-1/2 text-xs rounded-lg px-[30px] py-1 text-white"
                      >
                        REFUSER
                      </button>
                    </>
                  ) : notif.statusConfirmation ? (
                    <p className="relative p-1 bottom-2">
