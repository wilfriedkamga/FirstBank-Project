...
interface props{
    handleSave:(doc:DocumentModel)=>void;
    doc:DocumentModel
}

export default function EditButton({handleSave, doc}:props) {
      ...
      >
        ...
        <DialogContent dividers>
          ...
          >
            ...
            <Editor value={doc.description} style={{ height: "120px" }} />
            <TextareaAutosize />
          </Typography>
          <Typography gutterBottom>
            <LabelField text="Nom du document" />
            <TextFieldSimple  onChange={() => null} value={doc.name} />
          </Typography>
