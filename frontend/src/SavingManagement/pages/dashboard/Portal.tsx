...
import Navbar from "../../../UserManagement/User/Components/Elementary/Navbar/Navbar";
...
const Portal = () => {
  ...
  return (
    <div className="app">
      {isLoading ? (
        <div className="bg-white flex justify-center items-center  text-black h-[100vh] w-full">
          <img src={logo} alt="" />
          <DotLoader
            color={"red"}
            loading={isLoading}
          ...
          <div className="flex flex-col pt-5 h-full w-full space-y-8 overflow-auto">
            ...
            <div className="flex flex-row w-full justify-start space-x-6 md:space-x-24">
              <Link to="/newPlan" className="w-18 justify-center">
                <div className="rounded-lg h-16 w-16 border mb-1 mx-5 md:h-24 md:w-24 p-2.5 md:p-3.5">
                  <FontAwesomeIcon
                    icon={faPiggyBank}
                    size="lg"
              ...
              >
                <div className="rounded-lg border h-16 w-16 mb-1 mx-5 md:h-24 md:w-24 p-2.5 md:p-3.5">
                  <FontAwesomeIcon
