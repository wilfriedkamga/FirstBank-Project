  ...
  return (
    ...
    >
      ...
      <DialogContent dividers className="flex flex-col gap-2">
        ...
        <div className="flex flex-col gap-2">
          <label className="block font-bold text-sm  ">Rôle du membre</label>
          <SelectItem defaultValue="" onSelect={setFrequence} options={names} />
        </div>
      </DialogContent>
      <DialogActions>
...
export default function EditMembreAssociationDialog() {
  ...
  return (
    <>
      <div onClick={handleClickListItem} className="">
