  ...
  useEffect(() => {
    AssociationServices.GetAssociationDetails(location.pathname.split("/")[3])
      .then((response) => {
        ...
        setIsFunctional(response.data.estOperationel);
        setNbDocument("0");
      ...
      <div className="h-full  lg:p-4 ">
        {!isFunctional ? (
          <>
            ...
            <Box sx={{ flexGrow: 1 }}>
              <Grid sx={{marginBottom:"50px"}} container spacing={2} columns={16}>
                <Grid item xs={16}>
                  <Accordion
                    sx={{
                      bgcolor: "#ffffff",
                  ...
                  >
                    ...
                    <AccordionActions sx={{display:"flex", justifyContent:"end"}}>
                      <Button variant="contained" sx={{padding:"10px"}} color="success">Terminer</Button>
                    </AccordionActions>
                  </Accordion>
                </Grid>
              </Grid>
              <Grid sx={{marginBottom:"50px"}} container spacing={2} columns={16}>
                <Grid item xs={16} sx={{display:"flex", justifyContent:"space-between"}}>
                  <Button variant="contained" sx={{padding:"30px"}} color="error">Supprimer cette association</Button>
                  <Button variant="contained" sx={{padding:"30px"}} color="success">Ouvrir cette association</Button>
                </Grid>
              </Grid>
            </Box>
          </>
