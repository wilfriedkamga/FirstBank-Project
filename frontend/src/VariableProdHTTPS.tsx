class Variable {
  static routeApi: string = "https://62.169.22.170/"; //http://localhost:8088
  static routeApiTontine: string = "http://localhost:8081";
  static routeApiAssociation: string = "https://62.169.22.170"; //http://localhost:8082
  ...
  static notification_2 = "https://62.169.22.170"; //http://localhost:8091
