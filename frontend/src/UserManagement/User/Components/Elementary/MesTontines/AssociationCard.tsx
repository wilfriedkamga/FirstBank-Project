    ...
    <div className="w-full  bg-white shadow-md px-2 rounded">
      <div className="w-full flex justify-between">
        <div className="flex flex-1 gap-1 items-center text-sm font-medium">
          <span className="mb-2"> none</span>
        </div>
        {true ? (
          
          <button className="text-black font-extrabold text-lg mb-2" >
             <TooltipSpan text="..." tooltip={association.name} />
      ...
      <div className="flex justify-center items-center gap-9">
        <div className="flex gap-1 items-center text-sm text-gray-600">
          <PeopleOutlineIcon />
          <span>{association.nbMembre}</span>
        </div>
        <div className="flex gap-1 items-center text-sm text-gray-600 ">
          <SavingsOutlinedIcon />
          <span>{association.nbTontine}</span>
        </div>
        <div className="flex gap-1 items-center text-sm text-gray-600 ">
