...
const Signup: React.FC<ChildComponentProps> = ({
  ...
  const [dialogMessage,setDialogMessage]=useState("Incorrect password or phone")
  ...
  /**<div className="absolute  z-20 mr-10   mb-40 lg:mr-15 w-4/5">
                 <ProgressSpinner className=""  style={{width: '40px', height: '40px'}} strokeWidth="6" fill="white" animationDuration="1.5s" />
            </div> */
        ...
        <div className=" max-w-2xl mx-auto lg:w-4/5 ">
          <div className="w-full h-full  bg-gree-300 ">
            ...
            <div className="absolute z-20 ml-4 lg:ml-0  mt-20 lg:mt-20 lg:mr-15 w-4/5">
              {errorVisibility?<SimpleDialog message={dialogMessage} handleClose={()=>handleCloseDialog()} />:null}        
            </div>
