...
const PutPhone: React.FC<ChildComponentProps> = ({
  ...
  const messageError="The user with this phone number don't exist in our data base. Please verify the phone number"
...
/>
              ...
              <p className="mt-3 inline flex justify-center">
                Back to &nbsp; 
                <button className="signin text-red-400" onClick={() => togglePassword()}>
                  Signin
                </button>
              </p>
            </form>
