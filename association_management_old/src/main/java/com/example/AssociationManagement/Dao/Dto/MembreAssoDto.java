...
public  class MembreAssoDto {
    ...
    public MembreAssoDto(String id, String name, String phone, LocalDate creationDate, String role, boolean stateConfirmation, boolean statusConfirmation, String avatarUrl,boolean isCreator) {
        this.id = id;
        this.name = name;
        this.phone = phone;
    ...
    public MembreAssoDto(Membre_Asso membre_asso) {
        ...
        this.avatarUrl = null;
        this.isCreator=membre_asso.getIsCreator();
    }
